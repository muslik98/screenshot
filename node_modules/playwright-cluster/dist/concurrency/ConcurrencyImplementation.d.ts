...
export default abstract class ConcurrencyImplementation {
     ...
     */
    constructor(options: LaunchOptions, playwright: BrowserType<{}>, pageOptions: BrowserContextOptions | undefined);
    /**
     ...
     */
    abstract workerInstance(perBrowserOptions: LaunchOptions | undefined, perPageOptions: BrowserContextOptions | undefined): Promise<WorkerInstance>;
}
/**
...
export type ConcurrencyImplementationClassType = new (options: LaunchOptions, playwright: BrowserType<{}>, pageOptions: BrowserContextOptions | undefined) => ConcurrencyImplementation;
